...
class Dataset(object):
    ...
    #img_path = osp.join('/workspace/zigangzhao/Pose/TF-SimpleHumanPose', 'data', dataset_name, 'images')
    img_path = "/data/dyh/Pose/TF-SimpleHumanPose/data/MPII/images/"
    
    train_annot_path = "/data/dyh/Pose/TF-SimpleHumanPose/data/MPII/annotations/train.json"
    #train_annot_path = osp.join('/workspace1/zigangzhao/Pose/TF-SimpleHumanPose', 'data', dataset_name, 'annotations', 'output.json')
    #test_annot_path = osp.join('/workspace1/zigangzhao/Pose/TF-SimpleHumanPose', 'data', dataset_name, 'annotations', 'test.json')
    test_annot_path = "/data/dyh/Pose/TF-SimpleHumanPose/data/MPII/annotations/test.json"
    ...
    def load_val_data_with_annot(self): 
        ...
        for aid in coco.anns.keys():
            ...
            imgname = coco.imgs[ann['image_id']]['file_name']
            #bbox = ann['bbox']
            ww = coco.imgs[ann['image_id']]['width']
            hh = coco.imgs[ann['image_id']]['height']
            bbox = [0,0,ww,hh]
            joints = ann['keypoints']
            data = dict(image_id = ann['image_id'], imgpath = imgname, bbox=bbox, joints=joints, score=1)
