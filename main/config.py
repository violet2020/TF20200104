...
class Config:
    ...
    root_dir = "/data/dyh/Pose/TF-SimpleHumanPose/"
    data_dir = osp.join(root_dir, 'data')
    output_dir = osp.join(root_dir, 'output_mob_nobbox')
    ...
    ## model setting
    backbone = 'mobilenet_v2' # 'resnet50', 'resnet101', 'resnet152', 'mobilenet_v2'
    #init_model = osp.join(data_dir, 'imagenet_weights', 'resnet_v1_' + backbone[6:] + '.ckpt')
    init_model = osp.join(data_dir, 'imagenet_weights', 'mobv2_1.4_224', 'mobilenet_v2_1.4_224.ckpt')
