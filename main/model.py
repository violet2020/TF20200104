...
class Model(ModelDesc):
    ...
    def make_network(self, is_train):
        ...
        #resnet_fms = backbone(image, is_train, bn_trainable=False)
        '''
        ...
        with g.as_default():
            image11 = tf.placeholder(tf.float32, shape = [1, 256, 192, 3])
            moblienetv2_fms11 = backbone(image11)
            heatmap_outs11 = self.head_net(moblienetv2_fms11, is_train)
