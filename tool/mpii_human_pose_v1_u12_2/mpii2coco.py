...
save_path = '/workspace1/zigangzhao/Pose/TF-SimpleHumanPose/tool/mpii_human_pose_v1_u12_2/' + db_type + '.json'
...
for img_id in range(img_num):
    ...
    if ((db_type == 'train' and annot_file['img_train'][0][0][0][img_id] == 1) or (db_type == 'test' and annot_file['img_train'][0][0][0][img_id] == 0)) and \
        ...
        filename = "/workspace1/zigangzhao/data/MPII/images/" + str(annot_file['annolist'][0][0][0][img_id]['image'][0][0][0][0]) #filename
